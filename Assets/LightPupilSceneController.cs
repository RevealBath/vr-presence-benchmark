...
public class LightPupilSceneController : MonoBehaviour
{
    ...
    void Update()
    {
        if (DateTime.Now > sceneStart.AddSeconds(sceneDuration))
        {
            GameObject camera = GameObject.Find("pupil base");
            PupilBase fm = camera.GetComponent<PupilBase>();
